...
<div class="ruby-menu-demo-header">
      ...
      <div class="ruby-wrapper">
        ...
        <ul class="ruby-menu">
          ...
          <li class="ruby-menu-mega-blog ruby-menu-right"><a href="#">Blog</a>
                  ...
                  <div class="ruby-grid ruby-grid-lined" style="height: 264.359px;">
                    <div class="ruby-row">
                      <div class="ruby-col-6">
                        ...
                        <div class="ruby-row">
                          <div class="ruby-col-1"><img src="@/assets/combats/combat1.png"></div>
          ...
          <li class="ruby-menu-mega-shop ruby-menu-right"><a href="#">Shop</a>
