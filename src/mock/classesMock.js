...
export const noviceClasses = [
  ...
  },
  {
    ...
    weapons: ['Arc C'],
    mastery: ['+ 10 PV'],
    desc: "L'Archer est un expert du tir à l'arc, utilisant la précision et la portée pour atteindre ses cibles. Habile dans l'art de manier l'arc, il excelle à tirer des flèches avec une précision mortelle. L'Archer peut être équipé d'un arc court pour la rapidité dans les combats rapprochés, ou d'un arc long pour atteindre des cibles éloignées. Sa force réside dans sa capacité à attaquer à distance, harcelant les ennemis avant qu'ils ne puissent s'approcher. Certains Archers peuvent également avoir des compétences spéciales, comme le tir rapide, les tirs multiples ou l'utilisation de flèches spéciales avec des effets variés. En dehors du combat, l'Archer peut être un chasseur, un éclaireur ou un gardien des frontières, utilisant ses compétences pour protéger son peuple des menaces."
  },
  {
    name: `Voleur`,
